...
?>
<div id="pCard_<?= $slug ?>" class="absolute left-0 z-30 hidden p-4 py-8 bg-white rounded-md shadow-md lg:right-3/4 lg:left-auto lg:w-2/4 top-full lg:top-1/4 card_pillar">
