<section id="global_Youth_Experience" class="flex flex-col mt-24 lg:mt-16">
    <div class="flex grid-cols-12 lg:grid ">
        <iframe class="w-full col-span-10 lg:w-11/12 2xl:w-8/12 lg:mx-auto col-start-2 h-56 lg:h-[605px]" src="https://www.youtube.com/embed/uGsQw4T4udI?si=XiNpH2JGfg962rOn" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
    </div>
